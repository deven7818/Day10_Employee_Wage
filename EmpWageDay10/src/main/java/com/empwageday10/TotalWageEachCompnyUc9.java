 ...
 */
public class TotalWageEachCompnyUc9 {
	 ...
	 */
	TotalWageEachCompnyUc9(String companyName, int maxWorkingHrs, int WorkingDaysInMonth, int wagePerHr) {
	...
	public static void main(String[] args) {
		 ...
		 * creating Object
		 */
		TotalWageEachCompnyUc9 Dmart = new TotalWageEachCompnyUc9(" Dmart ", 100, 20, 100);
		Dmart.totalEmpWage();
		TotalWageEachCompnyUc9 Relaince = new TotalWageEachCompnyUc9(" Relaince ", 120, 25, 80);
